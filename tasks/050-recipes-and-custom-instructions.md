...
copy: long-term fundamentals, dividend income, swing trader. Store `recipe_key` on user
settings (or the watchlist — decide once, note it here). `custom_instructions` textarea
