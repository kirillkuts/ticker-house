...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      aria-pressed={ch}
      className="rounded-xl border border-neutral-200 dark:border-neutral-800 px-3 py-1.5 text-sm text-neutral-500 hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400"
    >
